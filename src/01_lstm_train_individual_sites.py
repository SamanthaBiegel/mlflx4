...
print("Starting one-site overfitting on LSTM model:")
...
# Generate filename
hparams = {"n_epochs": args.n_epochs, "early_stopping": args.early_stopping, "patience": args.patience, "hidden_units": args.hidden_size, "num_layers": args.num_layers, "dropout": args.dropout, "batch_size": args.batch_size, "learning_rate": args.learning_rate}
filename = generate_filename("lstm", "singlesites", hparams)
